...
class _JournalTabState extends State<JournalTab> {
  ...
  Future<void> _loadFullHistory() async {
    ...
    try {
       ...
       final res = await api.get('/entrenamientos/registros/cliente/${widget.cliente.id}/sesiones');
              ...
              children: [
                  ...
                  Center(
                      child: Column(
                          ...
                          children: [
                              Text(monthName, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18, letterSpacing: 1.2)),
                              const SizedBox(height: 4),
                              Text('${month.year}', style: const TextStyle(color: Colors.white54, fontSize: 14)),
                          ],
                      ),
                  ),
              ],
               ...
               Container(
                   ...
                   child: Row(
                       children: [
                           ...
                           Text(
                               _selectedMonth != null ? DateFormat('MMMM yyyy').format(_selectedMonth!).toUpperCase() : '',
