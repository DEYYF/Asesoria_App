...
class _FinanzasScreenState extends State<FinanzasScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      final resResumen = await api.get(
        '/finanzas/resumen?asesorId=${auth.userId}',
      );
      final resMovs = await api.get(
        '/finanzas/movimientos?asesorId=${auth.userId}',
      );

      if (resResumen.statusCode == 200 && resMovs.statusCode == 200) {
        setState(() {
          _resumen = jsonDecode(resResumen.body);
          _movimientos = jsonDecode(resMovs.body);
          _isLoading = false;
        });
      }
    } catch (e) {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    if (value.length < 3) return 'Descripción demasiado corta';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (_movimientos.isEmpty)
                    ...
                    ..._movimientos.map((m) => _buildMovimientoTile(m)),
  ...
  Widget _buildMovimientoTile(dynamic m) {
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: (isIngreso ? Colors.green : Colors.red).withOpacity(0.1),
